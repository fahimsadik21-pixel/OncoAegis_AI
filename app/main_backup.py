...
async def analyze_mri_brain(
    file: UploadFile = File(
        ...,
        description="One MRI NIfTI (.nii.gz) brain volume"
    ),
):
    """
    ...
    try:
        ...
        # Save uploaded NIfTI temporarily
        ...
        prediction = get_brain_service().predict(
            volume
        )
        ...
        mask_output = save_mask_as_nifti(
            ...
            temp_path,
            f"outputs/mri_masks/{output_name}",
        )
